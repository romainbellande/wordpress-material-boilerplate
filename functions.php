...
function bower_enqueue_assets() {
    ...
    // bower:css
    wp_enqueue_style('materialize-css',get_stylesheet_directory_uri() . '/bower_components/Materialize/bin/materialize.css');
    wp_enqueue_style('roboto-fontface-css',get_stylesheet_directory_uri() . '/bower_components/roboto-fontface/css/roboto-fontface.css');
    ...
    wp_enqueue_script('materialize-js',get_stylesheet_directory_uri() . '/bower_components/Materialize/bin/materialize.js');
...
add_action('wp_enqueue_scripts', 'bower_enqueue_assets'); // Add Bower components
